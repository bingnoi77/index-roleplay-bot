...
logger1 = logging.getLogger(__name__+"step3")
logger1.setLevel(level=logging.INFO)
log_dir="%s/dataset3"%log_dir
os.makedirs(log_dir,exist_ok=True)
handler1 = logging.handlers.TimedRotatingFileHandler("%s/step3.log"%log_dir, when='D', interval=1, backupCount=365)
